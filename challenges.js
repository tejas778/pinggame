var scores, roundscore, dice,activePlayer,gamePlaying,lastDice;
...
if(gamePlaying)
{
 ...
 document.querySelector('.btn-hold').addEventListener('click', function() {
     if(gamePlaying)
    {
    //add current score to gobalscore
    ...
    // update ui
     ...
     //to check who won
       ...
       {
           document.querySelector('#name-' + activePlayer).textContent='Congrats You have won!!!';
